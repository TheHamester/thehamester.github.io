function bio() { 
    return `
        ...
        <div class="pfp-wrapper">
            <img title="Art by Fauvfox" class="pfp" src="img/ham.png" width="200" height="200">
        ...
        <div class="links">
            <div>
                ...
                <p>Discord - <a href="javascript:copyHandle()">@hamester</a></p>
            </div>
            <div>
                ...
                <p>GitHub - <a target="_blank" href="https://github.com/TheHamester">TheHamester</a></p>
            </div>
            <div>
                ...
                <p>Steam - <a target="_blank" href="https://steamcommunity.com/id/hamester00/">Hamester</a></p>
            </div>
        </div>`;
}