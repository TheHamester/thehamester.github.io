...
export const html = /* html */ `
    <img title="Art by Axovoxel" class="character-img-left" src="img/characters/Sedo.png" width="200">
    <p>
    ...
    <h2>Origin</h2>
    <p>
        From blessed chrysalis emerged the horn of change.
        Was born an immortal catterpillar but became a goddess miraculously prematurely.
    </p>

    <h2>Relationships</h2>
    <img title="Art by Axovoxel" class="character-img-right" src="img/characters/OthMad.png" width="200">
    <p>
        <ul>
